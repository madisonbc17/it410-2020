<template>
    <aside class="offsidebar" v-show="loaded">
                    ...
                    <div class="row row-flush mb-2">
                        <div class="col mb-2">
                            <div class="setting-color">
                                <label>
                                    <input type="radio" name="setting-theme" checked="checked" v-model="themePath" value="themes/theme-a.css">
...
<script lang="ts">
    ...
    @Component
    export default class Offsidebar extends Vue {
        loaded : boolean = false;

        @Getter getSetting: any;
        @Getter getTheme: any;
        @Mutation changeSetting: any;
        @Mutation changeTheme: any;

        get isFixed (): boolean { return this.getSetting.isFixed }
        set isFixed (value) { this.changeSetting({name: 'isFixed', value}) }

        get isBoxed (): boolean { return this.getSetting.isBoxed }
        set isBoxed (value) { this.changeSetting({name: 'isBoxed', value}) }

        get isCollapsed (): boolean { return this.getSetting.isCollapsed }
        set isCollapsed (value) { this.changeSetting({name: 'isCollapsed', value}) }

        get isCollapsedText (): boolean { return this.getSetting.isCollapsedText }
        set isCollapsedText (value) { this.changeSetting({name: 'isCollapsedText', value}) }

        get isFloat (): boolean { return this.getSetting.isFloat }
        set isFloat (value) { this.changeSetting({name: 'isFloat', value}) }

        get asideHover (): boolean { return this.getSetting.asideHover }
        set asideHover (value) { this.changeSetting({name: 'asideHover', value}) }

        get asideScrollbar (): boolean { return this.getSetting.asideScrollbar }
        set asideScrollbar (value) { this.changeSetting({name: 'asideScrollbar', value}) }

        get themePath (): string { return this.getTheme }
        set themePath (value) { this.changeTheme(value) }
